...
public:
  ...
  void z_evolABS(float zr, std::vector<long double> &wave, std::vector<long double> &sed);//double dlum
  ...
  void modelC( float zr, std::vector <long double> &ex_curve,std::vector <long double> &ex_l,  std::vector<float> &ex_ls, std::vector <long double> &modC, double NHImean, double ZHImean);
...
//dust_attenuation variables
  std::vector<long double> modB;
  std::vector<long double> nspe;
